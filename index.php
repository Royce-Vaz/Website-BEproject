...
// Fetch user details from database using $_SESSION["user"] (assuming you have user details stored in the database)
// Example:
$userId = $_SESSION["user"];
// Fetch user details using $userId and display the greeting message
...
<body>
    ...
    <div id="myModal" class="modal">
        ...
        <div class="modal-buttons">
            <button id="RepresentationWindow">User Uploads</button>
            <button id="toggleCustomWindowButton">Reports</button>
            <!-- New button for toggling custom window -->
            <button id="toggleCustomDeleteWindowButton">Delete Entry</button>
    ...
    <div class="file-stats-popup">
        ...
        <p>Scope of Uploadation Next Year:
    ...
    <!-- Add this HTML section for the new window with buttons -->
    <div class="custom-window" id="customDeleteWindow">

        <h3>Delete Entries</h3>
        <div class="button-container">
            <a href="delete3.1.1.php" class="button">Delete Entry within 3.1.1</a>
            <a href="delete3.1.3.php" class="button">Delete Entry within 3.1.3</a>
            <a href="delete3.2.2.php" class="button">Delete Entry within 3.2.2</a>
            <a href="delete3.3.1.php" class="button">Delete Entry within 3.3.1</a>
            <a href="delete3.3.2.php" class="button">Delete Entry within 3.3.2</a>
            <a href="delete3.3.3.php" class="button">Delete Entry within 3.3.3</a>
            <a href="delete3.3.4.php" class="button">Delete Entry within 3.3.4</a>
            <a href="delete3.3.5.php" class="button">Delete Entry within 3.3.5</a>
            <a href="delete3.4.2.php" class="button">Delete Entry within 3.4.2</a>
            <a href="delete3.4.3.php" class="button">Delete Entry within 3.4.3</a>
            <a href="delete3.4.4.php" class="button">Delete Entry within 3.4.4</a>
            <a href="delete3.5.1.php" class="button">Delete Entry within 3.5.1</a>
            <a href="delete3.5.2.php" class="button">Delete Entry within 3.5.2</a>
        </div>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const customDeleteWindow = document.getElementById('customDeleteWindow');
            ...
            function toggleModal() {
                ...
                // If custom Delete window is active, close it
                if (customDeleteWindow.style.display === "block") {
                    customDeleteWindow.style.display = "none";
                }
            }
            ...
            document.getElementById("RepresentationWindow").addEventListener('click', function () {
                // Redirect the user to the Representation.php page
                window.location.href = 'Representation.php';
            });
            ...
            // Add this block to handle the custom Delete window toggle
            document.getElementById('toggleCustomDeleteWindowButton').addEventListener('click', function () {
                // Toggle the custom window visibility
                customDeleteWindow.style.display = (customDeleteWindow.style.display === "none" || customDeleteWindow.style.display === "") ? "block" : "none";

                // Hide the modal and overlay if the custom Delete window is active
                if (customDeleteWindow.style.display === "block") {
                    modal.style.transform = "translate(-50%, -50%) scale(0)";
                    setTimeout(() => {
                        modal.style.display = "none";
                ...
                // Show the overlay when the custom Delete window is active
                overlay.style.display = "block";

                // Add this event listener for the scrolling effect
                customDeleteWindow.addEventListener('scroll', function () {
                    const scrollAmount = customDeleteWindow.scrollTop;
                    const buttonContainer = customDeleteWindow.querySelector('.button-container');
